...
- [2025-10-05 14:27 UTC] SHA 6102b4f5ae53b18993624448fc4836746bc64672 — Added TAD Phase 2 DEM teacher: PyMatching-based `DEMMatchingTeacher`, Stim DEM cache helpers, CLI flags for correlated matching/rounds, and smoke coverage gated on optional deps. Commands: `conda run -n mlqec-env pytest tests/test_dem_surface_smoke.py -q`, `conda run -n mlqec-env pytest -q`. Metrics: DEM smoke gated on Stim/PyMatching; main suite stays green with optional warnings.
